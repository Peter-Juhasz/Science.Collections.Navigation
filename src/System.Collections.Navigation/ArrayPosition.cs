...
namespace System.Collections.Navigation
{
    public ref struct ArrayPosition<T>
    {
        ...
        public static ArrayPosition<T> operator +(ArrayPosition<T> left, ArrayPosition<T> right)
        {
        ...
        public static ArrayPosition<T> operator +(ArrayPosition<T> left, int right)
        {
            left.Offset(right);
            return left;
        }
