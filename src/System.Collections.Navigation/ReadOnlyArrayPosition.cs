...
namespace System.Collections.Navigation
{
    public ref struct ReadOnlyArrayPosition<T>
    {
        ...
        public static ReadOnlyArrayPosition<T> operator +(ReadOnlyArrayPosition<T> left, ReadOnlyArrayPosition<T> right)
        {
        ...
        public static ReadOnlyArrayPosition<T> operator +(ReadOnlyArrayPosition<T> left, int right)
        {
            left.Offset(right);
            return left;
        }
